...
function(){d(this).select()})})}};d.fn.jqCombo=function(b){if(m[b])return m[b].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return m.init.apply(this,arguments);d.error("Method "+b+" does not exist on jQuery.jqCombo");return!1}})(jQuery);$.extend($.expr[":"],{startswithi:function(d,q,i){return 0==(d.textContent||d.innerText||"").toLowerCase().indexOf((i[3]||"").toLowerCase())}});